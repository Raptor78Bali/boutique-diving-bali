...
export const metadata: Metadata = {
 ...
 description:
 "Take your diving further with private SSI Specialty courses in Bali. Deep Diving, Enriched Air Nitrox, Night Diving, Wreck Diving, Navigation, Perfect Buoyancy, and more — all taught one-on-one by your personal instructor at Bali's best dive sites.",
 keywords: [
...
export default function SpecialtyPage() {
 ...
 description: "Your personal diving instructor across all of Indonesia. Combine Specialties with liveaboard expeditions.",
